...
-(instancetype)populateCell:(ALMessage*) alMessage viewSize:(CGSize)viewSize
{
    ...
    {
        NSString * finalURl = [NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/staticmap?center=%@&zoom=14&size=290x179&maptype=roadmap&format=png&visual_refresh=true&markers=%@&key=%@",
