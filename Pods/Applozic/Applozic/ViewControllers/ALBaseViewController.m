...
static CGFloat const sendTextViewCornerRadius = 8.0f;
...
/*    self.placeHolderTxt = @"Write a Message...";
    ...
    */
    ...
    self.sendMessageTextView.backgroundColor =  [UIColor lightGrayColor];//[ALApplozicSettings getMsgTextViewBGColor];
