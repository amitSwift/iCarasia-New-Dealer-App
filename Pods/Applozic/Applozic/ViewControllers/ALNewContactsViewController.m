        ...
        case SHOW_CONTACTS:
        {
            ...
            if (contact)
            {
                ...
                else
                {
                    ...
                    newContactCell.selectionStyle = UITableViewCellSelectionStyleBlue ;
                }
    ...
    switch (self.forGroup.intValue)
    {
        ...
        { //DEFAULT : Launch contact!
            ...
            if(self.selectedSegment == 0)
            {
                ...
                ALChatViewController    * chatVC        = [storyBoard instantiateViewControllerWithIdentifier:@"ALChatViewController"];
                chatVC.contactIds                       = userId;
