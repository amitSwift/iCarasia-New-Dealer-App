...
#import "UUChart.h"
#import "iCarasia New Car Dealer App-Bridging-Header.h"
	...
	if (self.chartStyle == UUChartLineStyle) {
        if(!_lineChart){
            //_lineChart = [[UULineChart alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
             ...
             _lineChart = [[UULineChart alloc] initWithFrame:CGRectMake(0, 22, [[[NSUserDefaults standardUserDefaults]valueForKey:@"frameWidth"] integerValue], 100)];
