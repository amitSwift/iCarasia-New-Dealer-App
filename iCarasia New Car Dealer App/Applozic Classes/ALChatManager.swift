...
class ALChatManager: NSObject {
    ...
    static let applicationId = "trigma3562077492201b0dc3e12a5103e9fc947"
     ...
     func registerUser(_ alUser: ALUser) {
        ...
        registerUserClientService.initWithCompletion(alUser, withCompletion: { (response, error) in
            ...
            if (error != nil){
                ...
                ALUtilityClass.showAlertMessage("Invalid Passoword", andTitle: "Looped")
            }
            else{
                print("registered")
...
func ALDefaultChatViewSettings ()
{
     ...
     ALApplozicSettings.setStatusBarBGColor(UIColor(red:0/255, green:180.0/255, blue:240.0/255, alpha:1))
     ...
     */
     ...
     ALApplozicSettings.setColorForNavigation(UIColor(red:0/255, green:180.0/255, blue:240.0/255, alpha:1))
     ...
     ALApplozicSettings.setTitleForConversationScreen("MESSAGES")
