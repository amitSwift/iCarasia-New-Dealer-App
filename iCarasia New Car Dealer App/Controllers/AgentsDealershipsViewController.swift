//
//  AgentsDealershipsViewController.swift
//  iCarasia New Car Dealer App
//
//  Created by Raman Kant on 3/20/17.
//  Copyright © 2017 Raman Kant. All rights reserved.
//

import UIKit

class AgentsDealershipsViewController: UIViewController , UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "AgentsViewController") as! AgentsViewController
